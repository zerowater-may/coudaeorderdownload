...
from filtertable2 import AppDemo
...
# ///////////////////////////////////////////////////////////////
from . functions_main_window import *
from gui.uis.windows.main_window.setup_table_window import SetupTableWindow
from gui.uis.windows.main_window.adduserpage import AddUserPage # 회원 계정 페이지
from gui.uis.windows.main_window.addsheet import AddSheet # 스프레드시트 관리 페이지
# PY WINDOW
# ///////////////////////////////////////////////////////////////

# IMPORT DATABASES
# /////////////////////////////////////////////////////////////////
# from zerowaterdb import ServerDatabase
...
class SetupMainWindow:
    def __init__(self):
        ...
        self.con = self.configfile.read()
        self.ui.setup_ui(self)
        # self.db = ServerDatabase()
        # login = LoginSessionManageMent(parent=self)
        # # # TABLE WIDGET
        # self.tableWidget = SetupTableWindow()
    ...
    add_left_menus = [
        ...
        #     "is_active" : False
        # },
        # https://accounts.kakao.com/login/?continue=https%3A%2F%2Fdevelopers.kakao.com%2Flogin%3Fcontinue%3Dhttps%253A%252F%252Fdevelopers.kakao.com%252F&lang=ko
        # {
    ...
    def setup_gui(self):
        ...
        # MainFunctions.set_page(self, self.ui.load_widget.verticalLayoutWidget)
        ...
        # PY LINE EDIT
        self.search_line_edit = PyLineEdit(
            text = "",
            place_holder_text = "검색어를 입력하세요",
            radius = 8,
            border_size = 2,
            color = self.themes["app_color"]["text_foreground"],
        ...
        # self.ui.load_pages.row_4_layout.addWidget(self.search_line_edit)
        # self.ui.load_pages.row_5_layout.addWidget(self.table_widget)
        
        # TABLE WIDGET
        # self.tableWidget = SetupTableWindow()
        # self.ui.load_pages.row_5_layout.addWidget(self.tableWidget.table_widget)
        # # self.ui.load_pages.logo_layout.addWidget(self.button)
        # self.tableWidgets = SetupTableWindow()
        # self.ui.load_pages.verticalLayout_2.addWidget(self.tableWidgets.table_widget)
        # RIGHT COLUMN
        # ///////////////////////////////////////////////////////////////
        ...
        # ///////////////////////////////////////////////////////////////
        # 주문관리 타이틀
        self.ui.load_pages.title_label.setText('구매처 주문관리')
        self.ui.load_pages.title_label.setStyleSheet("font-size: 14pt; font-weight: bold;")
        self.ui.load_pages.title_label.setAlignment(Qt.AlignCenter)

        # 계정관리 타이틀
        self.ui.load_pages.label.setText('구매처 계정관리')
        self.ui.load_pages.label.setStyleSheet("font-size: 14pt; font-weight: bold;")
        self.ui.load_pages.label.setAlignment(Qt.AlignCenter)

        self.isapi = GoogleSpreadSheet().isapi(os.path.join(self.configfile.application_path,'setting.json'))

        self.ui.load_pages.label_2.setText(f'스프레드시트 정보\nAPI : {self.isapi}')
        self.ui.load_pages.label_2.setStyleSheet("font-size: 14pt; font-weight: bold;")
        self.ui.load_pages.label_2.setAlignment(Qt.AlignCenter)
...
########################################## MY CUSTOM ###################################################
        ...
        # 주문 관리하는 칸
        self.ordermanagement = OrderManagement(parent=self)
        self.ui.load_pages.row_3_layout.addWidget(self.ordermanagement.push_button_1)
        # self.ui.load_pages.row_3_layout.addWidget(self.icon_button_2)
        self.ui.load_pages.row_3_layout.addWidget(self.ordermanagement.spreadsheetupload_button)
        self.ui.load_pages.row_3_layout.addWidget(self.ordermanagement.exceldownload_button)
        self.ui.load_pages.row_3_layout.addWidget(self.ordermanagement.to_excel_uploadform_button)
        self.ui.load_pages.row_3_layout.addWidget(self.ordermanagement.ordertable_sync_button)
        self.ui.load_pages.row_3_layout.addWidget(self.ordermanagement.deleteorderdata)

        self.icon_button_2.clicked.connect(self.ordermanagement.updatespreadsheet)
        # self.ui.load_pages.row_5_layout.addWidget(self.ordermanagement.textbrowser)
        self.ui.load_pages.row_4_layout.addWidget(self.ordermanagement.orderTableWidget.table_widget)
        self.ui.load_pages.row_5_layout.addWidget(self.ordermanagement.textbrowser)
        self.ui.load_pages.page_2_layout.addWidget(self.ordermanagement.statusbar)
        # self.ui.load_pages.row_5_layout.setContentsMargins(1,1,1,1)
        # self.ui.load_pages.row_5_layout.setSpacing(20)

        
        # #### ANOTHER PAGE ###############################
        ## 계정 추가하는 칸
        self.adduserpage = AddUserPage(parent=self)

        # 계정정보 - 버튼추가
        self.ui.load_pages.horizontalLayout.addWidget(self.adduserpage.addUserPushButton)

        # 계정정보 - 검색필터링 추가
        # self.ui.load_pages.horizontalLayout.addWidget(self.search_line_edit)
        
        # 계정정보 - 검색필터링 추가
        self.ui.load_pages.horizontalLayout.addWidget(self.adduserpage.syncPushButton)

        # 계정정보 - 테이블이랑 추가
        self.ui.load_pages.verticalLayout_2.addWidget(self.adduserpage.myTableWidget.table_widget)
        # self.a = AppDemo()
        # self.ui.load_pages.verticalLayout_2.addWidget(self.a.filter_proxy_model)

        # 테이블 검색필터
        # self.search_line_edit.textChanged.connect(self.adduserpage.myTableWidget.proxy_model.setFilterFixedString)
    
        # self.ui.load_pages.verticalLayout_2.addWidget(self.adduserpage.myTableWidget.table_widget)
        
        # 계정정보 - 버튼눌렀을 시 반응
        self.adduserpage.addUserPushButton.clicked.connect(self.adduserpage.adduserbutton)

        # self.adduserpage.widget.saveBtn.clicked.connect(self.adduserpage.myTableWidget.table_widget)
        # self.ui.load_pages.label.setText(str(len((self.adduserpage.myTableWidget.result))))

        # self.tableWidget = SetupTableWindow()
        # self.ui.load_pages.row_5_layout.addWidget(self.adduserpage.self.table_widget)
        # self.ui.load_pages.logo_layout.addWidget(self.button)
        # self.tableWidgets = SetupTableWindow()
        ...
        self.addsheet = AddSheet(parent=self)

        # 스프레드시트정보 - 버튼추가
        self.ui.load_pages.horizontalLayout_2.addWidget(self.addsheet.addUserPushButton)

        # 스프레드시트정보 - 검색필터링 추가
        self.ui.load_pages.horizontalLayout_2.addWidget(self.addsheet.syncPushButton)

        # 스프레드시트정보 - 테이블이랑 추가
        self.ui.load_pages.verticalLayout_3.addWidget(self.addsheet.myTableWidget.table_widget)
