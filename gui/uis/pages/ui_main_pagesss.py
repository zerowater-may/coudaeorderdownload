...
class Ui_MainPages(object):
    def setupUi(self, MainPages):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 838, 578))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.layoutWidget = QWidget(self.scrollAreaWidgetContents)
        self.layoutWidget.setGeometry(QRect(0, 90, 831, 381))
        self.layoutWidget.setObjectName("layoutWidget")
        self.table_layout = QVBoxLayout(self.layoutWidget)
